...
-- Started on 2023-11-29 05:18:41
...
INSERT INTO public.dogs VALUES (87412, 33900, 'Hermenegildo', 'M', '2018-04-07', 'San Francisco', 'Golden Retriever. Honey colored fur. Family friendly, but naughty.', true, 'Miguel');
...
INSERT INTO public.dogs VALUES (87480, 33909, 'Milo', 'M', '2020-10-10', 'Houston', 'Australian shepherd. Dark brown eyes. Black and white with reddish brown spots on his beautiful face.', true, 'Francisco');
INSERT INTO public.dogs VALUES (87421, 33900, 'María Teresa', 'F', '2018-11-03', 'El Paso', 'Australian shepherd. Left eye is brown, right one is blue. Black with white. Very lovely.', false, 'no owner');
...
INSERT INTO public.health_records VALUES (14801, 87417, 92003, 'All vaccines have been administered. Next boost for rabies should be on June 2024.', 'Oliver is healty overall.');
...
INSERT INTO public.litters VALUES (33911, 87456, 87434, '2023-02-04', 'Denver', 'Dalmatians. Four puppies in total. All healthy.');
...
--
-- TOC entry 4748 (class 2606 OID 17158)
-- Name: dog_problems dog_problems_health_record_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.dog_problems
    ADD CONSTRAINT dog_problems_health_record_id_fkey FOREIGN KEY (health_record_id) REFERENCES public.health_records(health_record_id) ON DELETE SET NULL;


--
-- TOC entry 4749 (class 2606 OID 17163)
-- Name: dog_problems dog_problems_problem_code_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.dog_problems
    ADD CONSTRAINT dog_problems_problem_code_fkey FOREIGN KEY (problem_code) REFERENCES public.common_problems(problem_code) ON DELETE SET NULL;


--
-- TOC entry 4750 (class 2606 OID 17168)
-- Name: dogs dogs_born_in_litter_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.dogs
    ADD CONSTRAINT dogs_born_in_litter_id_fkey FOREIGN KEY (born_in_litter_id) REFERENCES public.litters(litter_id) ON DELETE SET NULL;


--
-- TOC entry 4751 (class 2606 OID 17173)
-- Name: health_records health_records_dog_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.health_records
    ADD CONSTRAINT health_records_dog_id_fkey FOREIGN KEY (dog_id) REFERENCES public.dogs(dog_id) ON DELETE SET NULL;


--
-- TOC entry 4752 (class 2606 OID 17178)
-- Name: health_records health_records_vet_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.health_records
    ADD CONSTRAINT health_records_vet_id_fkey FOREIGN KEY (vet_id) REFERENCES public.vets(vet_id) ON DELETE SET NULL;


--
-- TOC entry 4753 (class 2606 OID 17183)
-- Name: litters litter_dam_dog_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.litters
    ADD CONSTRAINT litter_dam_dog_id_fkey FOREIGN KEY (litter_dam_dog_id) REFERENCES public.dogs(dog_id) ON DELETE SET NULL;


--
-- TOC entry 4754 (class 2606 OID 17188)
-- Name: litters litter_sire_dog_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.litters
    ADD CONSTRAINT litter_sire_dog_id_fkey FOREIGN KEY (litter_sire_dog_id) REFERENCES public.dogs(dog_id) ON DELETE SET NULL;


--
-- TOC entry 4755 (class 2606 OID 17193)
-- Name: relationships relationships_dog_1_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.relationships
    ADD CONSTRAINT relationships_dog_1_id_fkey FOREIGN KEY (dog_1_id) REFERENCES public.dogs(dog_id) ON DELETE SET NULL;


--
-- TOC entry 4756 (class 2606 OID 17198)
-- Name: relationships relationships_dog_2_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.relationships
    ADD CONSTRAINT relationships_dog_2_id_fkey FOREIGN KEY (dog_2_id) REFERENCES public.dogs(dog_id) ON DELETE SET NULL;


--
-- TOC entry 4757 (class 2606 OID 17203)
-- Name: relationships relationships_relationship_code_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.relationships
    ADD CONSTRAINT relationships_relationship_code_fkey FOREIGN KEY (relationship_code) REFERENCES public.relationship_types(relationship_code) ON DELETE SET NULL;


-- Completed on 2023-11-29 05:18:41
